...
<html>
	...
	<script type="text/javascript">
		function updateJob() {
			...
			$.post(
					"${pageContext.request.contextPath}/job/updateJob",
					$("#jobForm").serialize(),function (data) {
						if(data == "OK"){
							alert("修改职位信息成功！");
							window.location.href = "${pageContext.request.contextPath}/job/selectJob?pageIndex=${pageIndex}";
						}else {
							alert("修改职位信息失败！");
    ...
    <td>
    	 <form action="" id="jobForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改 " onclick="updateJob()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
