...
<html>
	...
	<script type="text/javascript">
		function updateDept() {
			...
			$.post(
					"${pageContext.request.contextPath}/dept/updateDept",
					$("#deptForm").serialize(),
					function (date) {
						if(date=="OK"){
							alert("部门信息修改成功！");
							window.location.href="${pageContext.request.contextPath}/dept/selectDept?pageIndex=${pageIndex}";
						}else{
							alert("部门信息修改失败！");
    ...
    <td>
    	 <form action="" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="updateDept()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
