	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除部门",function(r){
	 				   if(r){
						   ...
						   $.get(
						   		"${pageContext.request.contextPath}/dept/deleteDept?ids="+ids.get(),
								   function (data) {
									   if(data=="OK"){
									   		alert("部门删除成功！");
									   		window.location.href="${pageContext.request.contextPath}/dept/selectDept";
									   }else if(data=="FAIL"){
									   		alert("部门删除失败！");
									   		window.location.reload();
									   }else if(data=="ERROR"){
									   		alert("该部门还存在员工，请将员工删除后再进行操作！");
									   		window.location.reload();
									   }
								   }
						   );
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/dept/selectDept?pageIndex={0}&name=${name}"/>
	  </td></tr>
	</table>
