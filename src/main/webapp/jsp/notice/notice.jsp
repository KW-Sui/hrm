	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除公告",function(r){
	 				   if(r){
						   ...
						   $.ajax({
							   type:'get',
							   url:'${pageContext.request.contextPath}/notice/removeNotice?ids=' + ids.get(),
							   success:function (data) {
								   if(data == "OK"){
								   	alert("删除公告成功！");
								   	window.location.href = "${pageContext.request.contextPath}/notice/selectNotice";
								   }else {
								   	alert("删除公告失败！");
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
			...
			<c:forEach items="${requestScope.notices}" var="notice" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/notice/findNoticeById?id=${notice.id}&pageIndex=${pageModel.pageIndex}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/notice/selectNotice?pageIndex={0}&title=${notice.title}&content=${notice.content}"/>
	  </td></tr>
	</table>
