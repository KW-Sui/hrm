			...
			function addNotice() {
				...
				$.ajax({
					...
					success:function (data) {
						if(data == "OK"){
							alert("添加公告成功！");
							window.location.href = "${pageContext.request.contextPath}/notice/selectNotice?pageIndex=${pageIndex}";
						}else{
							alert("添加公告失败，请重试！！");
		  	...
		  	<tr valign="top">
			    ...
			    <form id="noticeForm" name="noticeForm" action="" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
					...
					<input type="hidden" name="user.id" value="${login_user.id}">
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr><td class="font3 fftd">
								<input type="button" value="添加" onclick="addNotice()">
