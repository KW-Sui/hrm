	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
                               ...
                               $.get(
                                   "${pageContext.request.contextPath}/employee/deleteEmployee?ids="+ids.get(),
                                   function (data) {
                                       if(data == "OK"){
                                           alert("删除员工信息成功！");
                                           window.location.href= "${pageContext.request.contextPath}/employee/selectEmployee";
                                       }else{
                                           alert("删除员工信息失败，请重试！");
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/employee/findEmployeeById?id=${employee.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/employee/selectEmployee?pageIndex={0}&dept_id=${employee.dept.id}
	  	        &name=${employee.name}&card_id=${employee.card_id}&sex=${employee.sex}&phone=${employee.phone}&job_id=${employee.job.id}"/>
	  </td></tr>
	</table>
